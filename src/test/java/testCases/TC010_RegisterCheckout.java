...
public class TC010_RegisterCheckout extends BaseClass {

    @Test(groups = {"Regression", "Master"})
    public void verifyRegisterAndCheckout() throws InterruptedException {
        try {
            logger.info("***** Starting TC010_RegisterCheckout *****");
            ...
            logger.info("***** TC010_RegisterCheckout PASSED *****");

        } catch(Exception e) {
            logger.error("TC010_RegisterCheckout FAILED: " + e.getMessage());
