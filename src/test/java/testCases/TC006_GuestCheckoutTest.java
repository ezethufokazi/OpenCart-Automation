...
public class TC006_GuestCheckoutTest extends BaseClass {

    @Test(groups = {"Regression", "Master"})
    public void verifyGuestCheckout() throws InterruptedException {
        try {
            logger.info("***** Starting TC006_GuestCheckoutTest *****");
            ...
            logger.info("***** TC006_GuestCheckoutTest PASSED *****");

        } catch(Exception e) {
            logger.error("TC006_GuestCheckoutTest FAILED: " + e.getMessage());
