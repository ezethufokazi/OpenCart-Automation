...
public class TC010_LoggedInUserCheckoutNewAddress extends BaseClass {

	@Test(groups= {"Regression", "Master"})
	public void verifyLoggedInUserCheckout() throws InterruptedException {
		try {
			logger.info("***** Starting TC010_LoggedInUserCheckoutNewAddress *****");
			...
			if (existingAddress) {
					...
					cop.setLoggedInShippingAddress(firstName, lastName, addressline1, city, postcode, country, region);
					cop.clickContinue();
            ...
            logger.info("***** TC010_LoggedInUserCheckoutNewAddress PASSED *****");
			
		}  catch (Exception e) {
			 logger.error("TC010_LoggedInUserCheckoutNewAddress FAILED: " + e.getMessage());
